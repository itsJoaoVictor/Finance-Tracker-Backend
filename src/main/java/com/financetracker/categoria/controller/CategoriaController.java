...
public class CategoriaController {
    ...
    @PostMapping
    public ResponseEntity<CategoriaResponse> criar(@Valid @RequestBody CategoriaCriacaoRequest request) {
    ...
    public ResponseEntity<CategoriaResponse> editar(
            ...
            @Valid @RequestBody CategoriaEdicaoRequest request
    ) {
    ...
    public ResponseEntity<Void> excluirPermanentemente(@PathVariable UUID id) {
        categoriaService.excluirPermanentemente(id);
        return ResponseEntity.noContent().build();
    }
